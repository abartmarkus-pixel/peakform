...
- Ziel-Detailseite (`/goals/:id`, `GoalDetail.tsx`): Trainingsphasen-Grafik + datenbasierte Fortschrittsbeschreibung + Claude-freie Zielzeit-Schätzung (VO2max-Effizienz-Modell primär, Riegel-Distanz-Anker als Fallback); Wochenplan zeigt dieselbe live berechnete Phase jetzt ebenfalls als eigenes Badge statt Claudes eingefrorenem Freitext
